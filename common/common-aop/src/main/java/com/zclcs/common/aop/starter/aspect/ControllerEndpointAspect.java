package com.zclcs.common.aop.starter.aspect;
...
import com.zclcs.common.aop.starter.entity.ao.SystemLogAo;
...
public class ControllerEndpointAspect extends BaseAspectSupport {
    ...
    @Pointcut("execution(* com.zclcs..*.controller..*.*(..)) && @annotation(com.zclcs.common.aop.starter.annotation.ControllerEndpoint)")
...
//            systemLogAo.setUsername(username);
            ...
            rabbitTemplate.convertAndSend(RabbitConstant.LOG_EXCHANGE, RabbitConstant.SERVER_SYSTEM_LOG_ROUTE_KEY, MessageStruct.builder().message(objectMapper.writeValueAsString(systemLogAo)).build());
        }
        return result;
    }
