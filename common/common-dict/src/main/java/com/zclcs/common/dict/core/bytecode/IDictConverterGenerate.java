package com.zclcs.common.dict.core.bytecode;

import com.zclcs.common.core.enums.DictEnum;
import com.zclcs.common.dict.core.json.annotation.DictConverter;
...
public interface IDictConverterGenerate {
     ...
     * @param clazz 字典枚举对象
     * @return 泛型对象
     * @see GenericConversionService# getRequiredTypeInfo(Class, Class)
     */
