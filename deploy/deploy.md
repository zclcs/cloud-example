...
> - 使用 Dockerfile 构建基础镜像`docker build -t 192.168.33.10:3000/library/17-jdk-centos7:1.0.0 .`
> - push 镜像到harbor仓库`docker push 192.168.33.10:3000/library/17-jdk-centos7:1.0.0`
