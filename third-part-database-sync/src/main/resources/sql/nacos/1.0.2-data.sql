...
call insert_or_update(database(), 'config_info',
    ...
    `c_desc` = '网关路由配置', `c_use` = NULL, `effect` = NULL, `type` = 'json', `c_schema` = NULL, `encrypted_data_key` = ''
...
call insert_or_update(database(), 'config_info',
    ...
    `c_desc` = '网关限流配置', `c_use` = NULL, `effect` = NULL, `type` = 'json', `c_schema` = NULL, `encrypted_data_key` = ''
    WHERE `data_id` = 'gateway-flow.json' and `tenant_id` = '{{NACOS_NAMESPACE}}'");//
