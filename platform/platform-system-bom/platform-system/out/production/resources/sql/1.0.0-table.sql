...
(
    ...
    `service_package`      varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT '' COMMENT 'servcie文件存放路径',
...
(
    ...
    `login_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL     DEFAULT '01' COMMENT '登录类型 01 成功 02 失败 03 登出',
...
(
    ...
    `type`                  char(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NOT NULL DEFAULT '0' COMMENT '类型 @@sytem_menu.type',
