    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://2371219112.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <#if principalName=="anonymousUser">
                    未登录
                <#else>
                    <a target="_blank" href="https://2371219112.com">${principalName}</a>
                </#if>
            </p>
        </div>
    </div>
...
<footer>
    <p>support by: 2371219112.com</p>
    <p>email: <a href="mailto:2371219112@qq.com">2371219112@qq.com</a>.</p>
</footer>
</body>
</html>
