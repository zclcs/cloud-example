package com.zclcs.cloud.lib.dict.json.annotation;
 ...
 * <pre>
 * // class Bean {
 * //     @ DictText(name = BeanDictTypeKeyHandler.class)
 * //     private int key;
 * //     private int keyType;
 * // }
 * // public class BeanDictTypeKeyHandler implements DictTypeKeyHandler&lt;Bean&gt; {
 * //     @ Override
 * //     public String getName(final Bean bean, final String fieldName, final String fieldValue, final DictText dictText) {
...
public interface DictTypeKeyHandler<T> {
     ...
     * @return 字典类型代码
     */
    String getDictName(final T bean, final String fieldName, final String fieldValue, final DictText dictText);
}
